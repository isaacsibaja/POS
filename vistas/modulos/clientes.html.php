       ...
       <table class="table table-bordered table-striped dt-responsive tablas">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>isibajar91@hotmail.com</td>

            <td>85295771</td>

            <td>Monte verde la victoria</td>

            <td>1991-04-05 19:05:06</td>

            <td>53</td>

            <td>2018-04-05 19:05:06</td>

            <td>2016-04-05 19:05:06</td>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" min="0" class="form-control input-lg" name="nuevDocumentoId" placeholder="Ingresar cédula" required>
